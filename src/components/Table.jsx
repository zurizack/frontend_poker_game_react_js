...
import pokerTableDesktop from "../assets/images/poker_table.png"; // ייבוא תמונה לשולחן עבודה
import pokerTableMobile from "../assets/images/poker_table_for_mobile.png"; // ייבוא תמונה לנייד
